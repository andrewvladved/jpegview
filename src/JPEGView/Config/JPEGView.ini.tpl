...
; Scroll mode: how long the crossfade between two images lasts, in milliseconds.
; Zero means no crossfade.
; The 'Set Scroll Transition Time' entry of the Slideshow submenu writes this value.
